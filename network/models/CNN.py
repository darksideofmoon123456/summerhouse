...
class ResNet(nn.Module):
    ...
    def __init__(self, block, num_blocks, num_classes=1, in_channels=15, seq_length=100):
        ...
        # Dummy forward to calculate output dimension
        with torch.no_grad():
...
def ResNet18(in_channels=15, seq_length=100):
    return ResNet(BasicBlock, [2, 2, 2, 2], in_channels=in_channels, seq_length=seq_length)
